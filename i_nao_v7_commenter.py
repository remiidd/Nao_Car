...
def saveNaoImage(IP, PORT):                                  #Fonction pour prise d'images
    ...
    # photo
	s_cam = camProxy.setActiveCamera(videoClient, 1)
	print("changement de camera =", s_cam)
	print("La camera est", camProxy.getActiveCamera(videoClient))
...
def trajectoire():
	...
	cote = 0													#si la ligne est trop a gauche ou trop a droite ( sert a recentrer )
																# la voiture sur la ligne.
